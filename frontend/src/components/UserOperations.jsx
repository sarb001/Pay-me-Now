                                            ...
                                            {MoneyButtons?.map((item) =>
                                                <div>
                                                    <div className = 'grid grid-cols-2 m-2' key = {item.id}>
                                                        <button onClick={(e) => showmamount(e)} class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> 
                                                            {item.amount}  
                                                        </button>
                                                    </div>
                                                </div>
